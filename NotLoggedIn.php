...
<div id='upper-div'><h1 id='upper-div-title'>Food-Poll</h1><div id='home-div-out' class='block'><span class='block-span'>Home</span></div></div> 
     <div id='main-div'><div id='main-div-title'><span id='main-title-span' style='text-align: center;'>Food Poll</span><span id='main-descrpt-span'>Below is a list of common foods/ingredients <br>Select a food to see its voting results and place your vote, or sign-in to add a new food.</span></div>
